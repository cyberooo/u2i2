...
<img src="/docs/public/callgraphs/simplified_local_context_getimei.png" alt="The (simplified) call graph of getImei() in the local context" width="900"/>
(Click [[**simplified version**](/docs/public/callgraphs/simplified_local_context_getimei.png){:target="_blank"} or [**complete version**](/docs/public/callgraphs/local_context_getimei.png){:target="_blank"}] to view the original image in full size)
...
<img src="/docs/public/callgraphs/simplified_remote_context_getimei.png" alt="The (simplified) call graph of getImei() in the remote context" width="900"/>
(Click [[**simplified version**](/docs/public/callgraphs/simplified_remote_context_getimei.png){:target="_blank"} or [**complete version**](/docs/public/callgraphs/remote_context_getimei.png){:target="_blank"}] to view the original image in full size)
...
<img src="/docs/public/callgraphs/simplified_remote_context_getserial.png" alt="The (simplified) call graph of getSerial() in the remote context" width="900"/>
(Click [[**simplified version**](/docs/public/callgraphs/simplified_remote_context_getserial.png){:target="_blank"} or [**complete version**](/docs/public/callgraphs/remote_context_getserial.png){:target="_blank"}] to view the original image in full size)